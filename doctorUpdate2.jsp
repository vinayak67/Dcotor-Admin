...
<form action="save" method="Post" modelAttribute="doctor">
  <div class="container">
    ...
    <input id=fnameId type="text"  placeholder="Enter First Name" value="${doctor.firstname}" name="firstname"  required  >
 
 	 <label for="lname"><b>Last Name</b></label>
    <input id=lnameId type="text"  placeholder="Enter Last Name" value="${doctor.lastname}" name="lastname"  required  >
    ...
    <input id=contactId type="text"  placeholder="Enter Contact No." value="${doctor.contactnumber}" name="contactnumber"  required  >
    
    <label for="alt_contact_no"><b>Alternate Contact No.</b></label>
    <input id=altcontactId type="text"  placeholder="Enter Alternate Contact No." value="${doctor.atlcontactnumber}" name="atlcontactnumber"  required  >
    ...
    <input id=address_1_Id type="text"  placeholder="Enter Address line 1" value="${doctor.addressline1}" name="addressline1"  required  >
    
    <label for="address_2"><b>Adress line 2</b></label>
    <input id=address_2_Id type="text"  placeholder="Enter Address line 2" value="${doctor.addressline2}" name="addressline2"  required  >
    ...
    <input id=specialityId type="text"  placeholder="Enter Speciality" value="${doctor.specialty}" name="specialty"  required  >
    
    <label for="working_hours"><b>Working Hours</b></label>
    <input id=workinghrsId type="text"  placeholder="Enter Working Hours" value="${doctor.work_hours}" name="work_hours"  required  >
    
    <label for="hospital_name"><b>Hospital Name</b></label>
    <input id=hospitalId type="text"  placeholder="Enter Hospital Name" value="${doctor.hospital}" name="hospital"  required  >
    
     <label for="service_id"><b>Service ID</b></label>
    <input id=serviceId type="text"  placeholder="Enter Service ID" value="${doctor.medical_service_id}" name="medical_service_id"  required  >
